    ...
    return (
        <div className="policy_container">
            <div>
                ...
                `}</p>
                <span>{'6. Use of the Villa'}</span>
                <p>{`
                    All guests are expected to behave respectfully and responsibly during their stay. House rules for each villa are provided upon booking and must be adhered to. Violation of house rules may result in termination of your stay without refund.
                `}</p>
                <span>{'7. Disclaimer of Liability'}</span>
                <p>{`
                    We are not responsible for any damages, injuries, or losses that may occur during your stay at one of our villas. You agree to use the villas at your own risk and hold us harmless from any liability arising from your use.
                `}</p>
                <span>{'8. Governing Law and Dispute Resolution'}</span>
                <p>{`
                    These Terms shall be governed by and construed in accordance with the laws of Greece. Any dispute arising out of or relating to these Terms shall be subject to the exclusive jurisdiction of the courts of Greece.
                `}</p>
                ...
                <span>{'1. Data Collection and Storage'}</span>
                <p>{`
                    We only collect and store the following personal data from our website visitors:
                    - Email addresses
                    - Phone numbers
                    We collect this data when you contact us through our website contact form or subscribe to our mailing list (if applicable).
                `}</p>
                <span>{'2. Data Use and Processing'}</span>
                <p>{`
                ...
                <p>{`
                    We will retain your personal data for a period of one year after your last interaction with us. You may request deletion of your data at any time by contacting us.
                `}</p>
                ...
                <span>{'5. Cookies'}</span>
                <p>{`
                    Our website uses cookies to improve your user experience. You can find more information about our cookie policy on our website.
    ...
    return (
        <div className="policy_container">
            <div>
                ...
                <p>{`
                    Καλώς ήρθατε στις Ionian Island Villas, την πύλη σας για την εμπειρία πολυτελών ενοικιαζόμενων βίλλων στο όμορφο νησί της Λευκάδας. 
                    Οι παρόντες Όροι και Προϋποθέσεις Χρήσης ("Όροι") διέπουν την πρόσβασή σας και τη χρήση του ιστότοπου μας και των πληροφοριών και υπηρεσιών που παρέχονται εκεί. 
                    Με την πρόσβαση ή τη χρήση του ιστότοπου μας, αναγνωρίζετε ότι έχετε διαβάσει, κατανοήσει και συμφωνήσετε να υποχρεωθείτε από αυτούς τους Όρους.
                `}</p>
                ...
                <p>{`
                    Προσπαθούμε να παρέχουμε ακριβείς και ενημερωμένες πληροφορίες σχετικά με τις βίλλες μας στον ιστότοπό μας. 
                    Ωστόσο, δεν μπορούμε να εγγυηθούμε την πλήρη ακρίβεια, πληρότητα ή αξιοπιστία όλων των πληροφοριών. 
                    Οι περιγραφές και η διαθεσιμότητα των βίλλων υπόκεινται σε αλλαγές χωρίς προηγούμενη ειδοποίηση.
                `}</p>

                <span>{`4. Διαδικασία Κράτησης`}</span>
                <p>{`
                    Δεν προσφέρουμε δυνατότητα online κράτησης στον ιστότοπό μας. Για να ερωτηθείτε για την κράτηση μιας βίλλας, 
                    επικοινωνήστε απευθείας μαζί μας μέσω των πληροφοριών επικοινωνίας που παρέχονται στον ιστότοπό μας.
                `}</p>

                <span>{`5. Πληρωμές και Τιμές`}</span>
                <p>{`
                    Οι τιμές ενοικίασης για κάθε βίλλα αναφέρονται σαφώς στις αντίστοιχες σελίδες τους και μπορεί να ποικίλουν ανάλογα με την εποχή, 
                    τη διάρκεια της παραμονής και τις επιπλέον υπηρεσίες που ζητούνται. 
                    Η πλήρης πληρωμή απαιτείται κατά την επιβεβαίωση της κράτησης.
                `}</p>

                <span>{`6. Χρήση της Βίλλας`}</span>
                <p>{`
                    Αναμένεται από όλους τους επισκέπτες να συμπεριφέρονται με σεβασμό και ευθύνη κατά τη διάρκεια της παραμονής τους. 
                    Οι κανόνες σπιτιού για κάθε βίλλα παρέχονται κατά την κράτηση και πρέπει να τηρούνται. 
                    Η παραβίαση των κανόνων του σπιτιού μπορεί να οδηγήσει στη λήξη της παραμονής σας χωρίς επιστροφή χρημάτων.
                `}</p>

                <span>{`7. Αποποίηση Ευθύνης`}</span>
                <p>{`
                    Δεν είμαστε υπεύθυνοι για οποιεσδήποτε ζημιές, τραυματισμούς ή απώλειες που ενδέχεται να προκύψουν κατά τη διάρκεια της παραμονής σας σε μια από τις βίλλες μας. 
                    Συμφωνείτε να χρησιμοποιείτε τις βίλλες με δική σας ευθύνη και να μας απαλλάσσετε από κάθε ευθύνη που προκύπτει από τη χρήση σας.
                `}</p>

                <span>{`8. Εφαρμοστέο Δίκαιο και Επίλυση Διαφορών`}</span>
                <p>{`
                    Οι παρόντες Όροι διέπονται και ερμηνεύονται σύμφωνα με τους νόμους της Ελλάδας. 
                    Κάθε διαφορά που προκύπτει από ή σχετίζεται με τους παρόντες Όρους υπόκειται στην αποκλειστική δικαιοδοσία των δικαστηρίων της Ελλάδας.
                `}</p>

                <span>{`9. Τροποποιήσεις στους Όρους`}</span>
                <p>{`
                    Διατηρούμε το δικαίωμα να τροποποιούμε αυτούς τους Όρους οποτεδήποτε χωρίς προηγούμενη ειδοποίηση. 
                    Η συνεχής χρήση του ιστότοπου μας μετά από οποιαδήποτε τέτοια τροποποίηση αποτελεί αποδοχή των τροποποιημένων Όρων.
                `}</p>

                <span>{`10. Στοιχεία Επικοινωνίας`}</span>
                <p>{`
                    Εάν έχετε οποιεσδήποτε ερωτήσεις σχετικά με αυτούς τους Όρους, παρακαλούμε επικοινωνήστε μαζί μας μέσω των πληροφοριών που παρέχονται στον ιστότοπό μας.
                `}</p>

                <span>{`Συμμόρφωση με το GDPR`}</span>
                <span>{`1. Συλλογή και Αποθήκευση Δεδομένων`}</span>
                <p>{`
                    Συλλέγουμε και αποθηκεύουμε μόνο τα εξής προσωπικά δεδομένα από τους επισκέπτες του ιστότοπού μας:
                    Διευθύνσεις email
                    Αριθμοί τηλεφώνου
                    Συλλέγουμε αυτά τα δεδομένα όταν επικοινωνείτε μαζί μας μέσω της φόρμας επικοινωνίας του ιστότοπού μας ή εγγράφεστε στον κατάλογο αλληλογραφίας μας (εάν είναι εφαρμοστέο).
                `}</p>

                <span>{`2. Χρήση και Επεξεργασία Δεδομένων`}</span>
                <p>{`
                    ...
                    Δεν θα μοιραστούμε τα προσωπικά σας δεδομένα με τρίτους χωρίς τη συγκατάθεσή σας.
                `}</p>
                <span>{`3. Διατήρηση Δεδομένων`}</span>
                <p>{`
                    Θα διατηρήσουμε τα προσωπικά σας δεδομένα για ένα διάστημα ενός έτους μετά την τελευταία σας αλληλεπίδραση μαζί μας. 
                    Μπορείτε να ζητήσετε τη διαγραφή των δεδομένων σας οποτεδήποτε επικοινωνώντας μαζί μας.
                `}</p>
                <span>{`4. Τα Δικαιώματά Σας`}</span>
                <p>{`
                ...
                <span>{`5. Cookies`}</span>
                <p>{`
                    Ο ιστότοπός μας χρησιμοποιεί cookies για τη βελτίωση της εμπειρίας χρήστη σας. 
                    Μπορείτε να βρείτε περισσότερες πληροφορίες σχετικά με την πολιτική μας για τα cookies στον ιστότοπό μας.
                    Αυτό είναι ένα αφετηριακό σημείο για τους όρους χρήσης και τη συμμόρφωση με το GDPR. 
                    Σημειώνεται ότι αυτό δεν αντικαθιστά τη νομική συμβουλή, και συνιστάται η συμβουλή με δικηγόρο για την εξασφάλιση της συμμόρφωσης των όρων χρήσης με όλους τους ισχύοντες νόμους και κανονισμούς.
                `}</p>
            </div>
        </div>
    )
    ...
    return (
        <div className="policy_container">
            <div>
                ...
                <p>{`Die Mietpreise für jede Villa sind auf ihren jeweiligen Seiten deutlich angegeben und können je nach Saison, Aufenthaltsdauer und angeforderten zusätzlichen Dienstleistungen variieren. Die vollständige Zahlung ist bei Bestätigung Ihrer Buchung erforderlich.`}</p>
                ...
                <p>{`Wir behalten uns das Recht vor, diese Bedingungen jederzeit ohne vorherige Ankündigung zu ändern. Ihre fortgesetzte Nutzung unserer Website nach einer solchen Änderung stellt Ihre Zustimmung zu den geänderten Bedingungen dar.`}</p>
                ...
                <p>{`1. Datensammlung und -speicherung\nWir sammeln und speichern nur die folgenden personenbezogenen Daten von Besuchern unserer Website:\n- E-Mail-Adressen\n- Telefonnummern\nDiese Daten werden erfasst, wenn Sie uns über das Kontaktformular unserer Website kontaktieren oder sich für unseren Newsletter anmelden (falls zutreffend).`}</p>

                <p>{`2. Datenverwendung und -verarbeitung\nWir verwenden Ihre personenbezogenen Daten für folgende Zwecke:\n- Beantwortung Ihrer Anfragen und Anfragen\n- Senden von Informationen zu unseren Villen und Sonderangeboten (sofern Sie sich für unseren Newsletter anmelden)\nWir werden Ihre personenbezogenen Daten ohne Ihre Zustimmung nicht an Dritte weitergeben.`}</p>

                <p>{`3. Datenspeicherung\nWir speichern Ihre personenbezogenen Daten für einen Zeitraum von einem Jahr nach Ihrem letzten Kontakt mit uns. Sie können jederzeit die Löschung Ihrer Daten beantragen, indem Sie uns kontaktieren.`}</p>

                <p>{`4. Ihre Rechte\nSie haben nach der DSGVO folgende Rechte:\n- Recht auf Zugang zu Ihren personenbezogenen Daten\n- Recht auf Berichtigung ungenauer oder unvollständiger Daten\n- Recht auf Löschung Ihrer Daten\n- Recht auf Einschränkung der Verarbeitung Ihrer Daten\n- Recht auf Datenübertragbarkeit\n- Recht, der Verarbeitung Ihrer Daten zu widersprechen\nSie können diese Rechte ausüben, indem Sie uns über die auf unserer Website angegebenen Informationen kontaktieren.`}</p>

                <span>{`5. Cookies`}</span>
                <p>{`Unsere Website verwendet Cookies, um Ihre Benutzererfahrung zu verbessern. Weitere Informationen zu unserer Cookie-Richtlinie finden Sie auf unserer Website.\nDies ist ein Ausgangspunkt für Ihre Nutzungsbedingungen und DSGVO-Konformitätserklärung. Es ist wichtig zu beachten, dass dies keinen Ersatz für rechtliche Beratung darstellt und Sie sich mit einem Anwalt in Verbindung setzen sollten, um sicherzustellen, dass Ihre Nutzungsbedingungen den geltenden Gesetzen und Vorschriften entsprechen.`}</p>
            </div>
        </div>
    );
};
